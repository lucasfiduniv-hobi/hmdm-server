...
document.localization ['pt_PT'] = {
    ...
    'form.configuration.settings.mdm.kiosk.screen': 'Ecrã sempre ligado',
    ...
    'form.configuration.settings.mdm.extras': 'Extras de administrador',
    'form.configuration.settings.mdm.extras.placeholder': 'Definições MDM extra separadas por vírgula, por exemplo:\n"com.hmdm.OPEN_WIFI": true',
    'form.configuration.settings.mdm.permissive.locked': 'Desativar o modo quiosque para ativar a opção de modo permissivo',

...
document.localization ['en_US'] = {
    ...
    'form.configuration.settings.mdm.kiosk.screen': 'Screen always on',
    ...
    'form.configuration.settings.mdm.extras': 'Admin extras',
    'form.configuration.settings.mdm.extras.placeholder': 'comma-separated extra MDM settings, e.g.:\n"com.hmdm.OPEN_WIFI": true',
    'form.configuration.settings.mdm.permissive.locked': 'Turn off kiosk mode to enable the permissive mode option',
